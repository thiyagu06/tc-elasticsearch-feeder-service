...
/**
 * Resource to handle the challenge details feeder
 * 
 * 
 * @author TCSCODER
 * @version 1.0
...
public class ChallengeDetailsFeederResource {
	 ...
	 *
	 * @param challengeDetailsFeederManager
	 *            the challengeManager to use
	 */
	...
	/**
	 * Push challenge deatails feeders to elasticsearch service
	 *
	 * @param request
	 *            the request
	...
	@Timed
	@AllowAnonymous
	public ApiResponse pushChallengeDetailsFeeders(@Valid PostPutRequest<ChallengeFeederParam> request) {
		try {
			...
			this.challengeDetailsFeederManager.pushChallengeDetailsFeeder(request.getParam());
